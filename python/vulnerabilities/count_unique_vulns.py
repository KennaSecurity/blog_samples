...
# occurance of the CVE ID which could be a CVE or informational.
#
...
def print_help():
    ...
    print("")
    print("Counts unique CVE IDs, displays the top ten, and puts them all in a CSV file.")
    print("CVE IDs can be in the CVE form or informational.")
...
def process_cve_id_in_vuln(vuln, cve_counts):
    ...
    # Obtain the CVE ID, both CVE for and informational.
    cve_id = vuln['cve_id']
